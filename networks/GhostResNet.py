...
class GhostResNet(nn.Module):
    def __init__(self, block, layers, num_classes=9, s=4, d=3):
        self.inplanes = 64
...
def ghostresnet50(num_classes=9, **kwargs):
    model = GhostResNet(Bottleneck, [3, 4, 6, 3], num_classes=num_classes, **kwargs)
    return model
