...
def test(args):
    # 测试集路径和保存结果的CSV文件路径
    test_data_dir = args.test_path
    model_name = args.model_name
    output_csv_path = "./results/" + model_name + '/output_' + model_name + '.csv'
    ...
    model.load_state_dict(torch.load("./models/" + model_name + "/best_model.pth"))  # 加载最优模型权重
